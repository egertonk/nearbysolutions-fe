...
export const diyToolListings: DIYToolListing[] = [
  {
    ...
    powerSource: "Corded",
    imageUrls: [
      "https://media.istockphoto.com/id/1301284563/photo/circular-saw.jpg?s=2048x2048&w=is&k=20&c=aZQwOhoSttGJ5GVs-DPCy7MKPoWeWvJcASWoH8cjrM8=",
    ],
    customerId: "",
    renterId: "",
    ...
    discountPercent: 30,
    returnDate: "",
    usageInstructions: "Ensure the blade guard is functional before use.",
    safetyInformation: "Use gloves and eye protection when operating.",
  },
  {
    toolId: "54321",
    toolName: "Power Sander",
    description:
    ...
    powerSource: "Corded",
    imageUrls: [
      "https://media.istockphoto.com/id/1277325678/photo/power-sander.jpg?s=2048x2048&w=is&k=20&c=YFxkMGDO2Yv_wJFPuAaB05uVPsFtEvnzVp_HuP6kce8=",
    ],
    customerId: "",
    renterId: "",
    ...
    discountPercent: 0,
    returnDate: "",
    usageInstructions: "Keep the sanding pads clean for optimal performance.",
    safetyInformation: "Avoid prolonged use to prevent overheating.",
  },
  {
    toolId: "98765",
    toolName: "Lawn Mower",
    ...
    imageUrls: [
      "https://media.istockphoto.com/id/1253836724/photo/lawn-mower.jpg?s=2048x2048&w=is&k=20&c=6eH0bx1qCpKFI_2BsKAUOCxHP1gpK_HsE2r6VRsoBmc=",
    ],
    customerId: "",
    renterId: "",
    isShippingValid: false,
    ...
    discountPercent: 20,
    returnDate: "",
    usageInstructions: "Fill the tank with unleaded fuel before use.",
    safetyInformation: "Avoid mowing on steep slopes to prevent accidents.",
  },
  {
    toolId: "19283",
  ...
  },
  {
    ...
    powerSource: "Electric",
    imageUrls: [
      "https://media.istockphoto.com/id/1410987895/photo/pressure-washer.jpg?s=2048x2048&w=is&k=20&c=fv2zTCiGHZqOw9frVpz-DNUBHE7cwZFAgGsFy7kpyDA=",
    ],
    customerId: "",
    renterId: "",
    isShippingValid: true,
    ...
    discountPercent: 10,
    returnDate: "",
    usageInstructions: "Use the appropriate nozzle for each cleaning task.",
    safetyInformation: "Do not direct the spray at people or animals.",
  },
  {
    toolId: "54321",
    toolName: "Power Sander",
