...
export const Register: React.FC = () => {
  return (
    <form>
      <div className="flex flex-col text-left justify-center items-center space-y-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 flex items-center gap-x-3">
                ...
                <button
                  type="button"
                  className="rounded-md text-white bg-purple-400 px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset hover:bg-purple-500"
                >
                  Change
                </button>
              </div>
