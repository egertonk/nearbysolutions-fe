...
export const SideMenuList: React.FC = () => {
  const menuItemCSS =
    "text-white text-sm flex items-center hover:bg-gray-700 rounded px-4 transition-all";
  // Show only customer orders
  return (
    <>
      <div className="relative  md:py-8 flex flex-col  shadow-">
        <nav className="bg-[#121e31] top-0 min-w-[250px] py-6 px-4 font-[sans-serif] tracking-wide ">
          ...
          <ul className="space-y-3">
            ...
            <Link type="button" className={menuItemCSS} to={`/job-listings`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="w-[18px] h-[18px] mr-4"
            ...
            <Link to={`/tool-listings`} type="button" className={menuItemCSS}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="w-[18px] h-[18px] mr-4"
          ...
          <ul className="space-y-3">
            <Link to={`/hire-a-talent`} type="button" className={menuItemCSS}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="w-[18px] h-[18px] mr-4"
            ...
            <Link type="button" className={menuItemCSS} to={`/post-a-job`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="w-[18px] h-[18px] mr-4"
            ...
            <Link type="button" className={menuItemCSS} to={"/gift-a-solution"}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="w-[18px] h-[18px] mr-4"
            ...
            <Link type="button" className={menuItemCSS} to={`/favorite`}>
              {" "}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
            ...
            <Link type="button" className={menuItemCSS} to={`/reviews`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="w-[18px] h-[18px] mr-4"
